...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXN5bGNyZWVrIiwiYSI6ImNrY3V2Nmt5czF5OW4ycnQ2NGJpbHR5eHgifQ.s2D0-dNq0to4nNyR9TofiA';
...
exports.default = exports.hideAlert = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            (0, _alerts.default)('error', 'Error logging out. Please try again');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://127.0.0.1:3000/api/v1/users/update-my-data' : 'http://127.0.0.1:3000/api/v1/users/update-password';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51H8hhWDfO034zfR66jZbmPoIeQUCkdIWOEJ4dqzqXOZOkYwfpjc5bArgLFWu12pnVvZvRdvDBCVqbhfWfNYMjJWT00QmGq3HYS');
